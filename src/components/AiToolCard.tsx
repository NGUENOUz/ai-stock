...
export const AiToolCard: React.FC<AiToolCardProps> = ({ tool }) => {
  ...
  const flameGifUrl =
    "https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExOWdrZDFyaW82cnJyazYwN3Znb24wc3Y1bjhldHdhNWhldXZ4aWZkdyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/UqUHuT6y9mK5HfsYFm/giphy.gif";
        ...
        >
         ...
         <Link href={detailPageUrl} className="block cursor-pointer">
          ...
          <div className="flex items-center gap-4 mb-4">
            {" "}
            {/* flex et gap pour aligner logo et titre/badge */}
            {/* Logo de l'IA */}
            ...
            <div className="">
              {" "}
              {/* Permet au texte de prendre l'espace */}
              <div>
                <CardItem
                  translateZ="50"
                ...
                >
                  ...
                  {tool.is_featured && ( // Utilise is_featured comme indicateur de vérification premium
                    <span
                      ...
                      title="Vérifié et en vedette text-sm"
                    >
                      <VerifiedIcon />
                    </span>
                  )}
              ...
              `}
                >
                  {tool.pricing || "N/A"}{" "}
                  {/* Affiche le prix ou "N/A" si non défini */}
                </CardItem>
          ...
          >
            {truncateDescription(tool.description_short ?? null, 40)}{" "}
            {/* Augmenté à 60 pour un peu plus de contexte, tu peux ajuster */}
          </CardItem>
