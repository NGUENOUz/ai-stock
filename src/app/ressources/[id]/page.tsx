    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B1120] font-sans text-slate-900 dark:text-white pt-28 pb-24">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <Link href="/ressources" className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-primary transition-colors bg-white dark:bg-[#0F172A] px-4 py-2 rounded-xl shadow-sm border border-slate-200/60 dark:border-slate-800">
