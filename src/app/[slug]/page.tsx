...
const AiToolDetailsPage = async ({ params }: AiToolDetailsPageProps) => {
  ...
  const { data: featuredTools, error: featuredError } = await getFeaturedTools(
    4
  ); // Limite à 4
  ...
  const { data: relatedTools, error: relatedError } =
    await getRelatedAiToolsByCategory(tool.categories, tool.id, 6); // Limite à 6 pour le carrousel
      ...
      <div className="container mx-auto px-4 py-8 text-neutral-200 mt-20">
        ...
        <nav className="mb-8 text-sm md:text-base">
          <ol className="list-none p-0 inline-flex">
            ...
            <li className="text-gray-400">{tool.name}</li>
          </ol>
        </nav>
          ...
          <div className="lg:w-2/3">
            <div className="titleDescription flex flex-row gap-5 h-20 item-center">
              ...
              ${
                tool.pricing === "Gratuit"
                  ? "bg-green-500 text-green-900 border-green-700"
                  : tool.pricing === "Essai Gratuit"
                  ? "bg-blue-500 text-blue-900 border-blue-700"
                  : tool.pricing === "Freemium"
                  ? "bg-purple-500 text-purple-900 border-purple-700"
                  : tool.pricing === "Payant"
                  ? "bg-red-500 text-red-900 border-red-700"
            ...
            <p className="text-neutral-300 text-base leading-relaxed">
              {tool.description_long ||
                ...
                "Aucune description complète disponible pour le moment."}
            </p>
        ...
        {featuredTools && featuredTools.length > 0 && (
          <section className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
              {" "}
              {/* Utilise justify-items-center pour centrer les cartes */}
        ...
        <div className="mt-12 text-center">
          <Link
            href="/liste"
            className="inline-flex items-center text-blue-400 hover:text-blue-500 text-lg px-6 py-3 rounded-xl border border-blue-400 hover:border-blue-500 transition-colors duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
